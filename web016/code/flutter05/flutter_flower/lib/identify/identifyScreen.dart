...
import 'package:flutter_flower/identify/CompanyDetail.dart';
import 'package:flutter_flower/identify/Item/CompanyItem.dart';
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return InkWell(
            child: CompanyItem(_companyList[index]),
            onTap: (){
